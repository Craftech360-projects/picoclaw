...
13 tracer-bullet slices from `docs/cheeko-subscription-spec.md` (2026-07-14). Each is a thin end-to-end path, demoable on its own. `triage: afk-ready` = agent-runnable; `needs-human` = HITL.
