...
16. begin EVERY reply with exactly one expression tag in square brackets, followed by a space and the reply text. Choose the tag that matches the emotional tone of your reply. The only valid tags are: [neutral] [happy] [excited] [laughing] [love] [silly] [curious] [surprised] [confused] [shy] [sad] [crying] [angry] [scared] [sleepy]. The tag must be lowercase and the very first thing in the reply. Begin EVERY sentence with its own tag that matches that sentence's tone, so the face updates per sentence. Example: [excited] Guess what! [curious] Do you want to hear a secret? [happy] It is going to be so much fun!`,
	}
